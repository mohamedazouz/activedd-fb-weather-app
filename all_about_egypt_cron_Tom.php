            ...
            $(document).ready(function(){
                ...
                function post_page(page,response,text){
                    ...
                    var jsonData={
                        ...
                        caption:response.data.weather[1].tempMaxC + " &deg;C  - " + response.data.weather[1].windspeedKmph+" Kmph",
                        img:response.data.weather[1].weatherIconUrl[0].value,
                        des:response.data.weather[1].weatherDesc[0].value
                    }
